...
namespace TwoDimmArraysAndNestedForLoops
{
    ...
    {
        // TODO #1 Just make it work

        // TODO #2 now make it work without keeping an incrementing index
    }

    inline void Ex2_print__Grid_XxY__FullOf_Param()
    {
        // TODO
    }
    ...
    inline void runAll()
    {
        ...
        //  (nothing)
        //
        // Ex2_print__Grid_XxY__FullOf_Param(0, 0, '*');
        std::cout << std::endl << std::endl;
